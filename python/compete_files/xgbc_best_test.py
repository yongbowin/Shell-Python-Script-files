...
xgbc_best_y_predict = loaded_model.predict_proba(X_test)[:, 1]
#进行准确性评测
...
xgbc_submission = pd.DataFrame({'id': stock_test['id'], 'proba': xgbc_best_y_predict})
xgbc_submission.to_csv('xgbc_best_submission.csv', index=False) 